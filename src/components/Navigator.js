            ...
            <Fragment>
                <ul className="navigator-menu list-unstyled">
                    {menus.map((menu, menuIndex) => {
                        // Kiểm tra xem menu có subMenus hay không
                        const isMenuHasSubMenuActive = this.isMenuHasSubMenuActive(location, menu.subMenus, menu.link);
                        const isSubMenuOpen = this.state.expandedMenu[menuIndex] === true;
                                ...
                                {menu.subMenus &&
                                    menu.subMenus.map((subMenu, subMenuIndex) => (
                                        <SubMenuWithRouter
                                            ...
                                            onLinkClick={onLinkClick}
                                            className={onLinkClick==subMenu.link?"active":""}
                                        />
                                    ))}
                            </MenuWithRouter>
                        );
